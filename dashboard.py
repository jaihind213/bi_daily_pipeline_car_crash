...
blob_store_path = os.environ.get("BLOB_STORE_PATH", "s3a://pygxro/crash_data/iceberg/db/crashes_cube")
...
setup_blob_store_auth(con, os.environ.get("BLOB_STORE_ACCESS_KEY", "DO801WCTHEVPAP279WM2"),
                      os.environ.get("BLOB_STORE_SECRET_KEY", "P8PJOfT/mRd0rIa+E5uCYoxeMwFSzpctgpq3cmIaFbA"))
